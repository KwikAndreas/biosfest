...
export default function LombaWebDevPage() {
  return (
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900 text-white pt-32 pb-20 px-4">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="inline-block mb-4">
            <span className="px-4 py-2 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-300 text-sm font-semibold backdrop-blur-sm">
              Kategori Mahasiswa
            </span>
          </div>
          ...
          <p className="text-xl md:text-2xl mb-4 text-slate-200 font-medium">
            Solusi Web untuk Pemberdayaan UMKM Indonesia
          </p>
          <p className="text-base md:text-lg mb-10 max-w-3xl text-slate-300 leading-relaxed">
            Bangun aplikasi web yang membantu UMKM mengelola bisnis secara
            digital dengan fitur manajemen produk, pencatatan transaksi, dan
            analisis penjualan.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/daftar"
              className="group px-8 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-full font-bold text-lg hover:from-purple-500 hover:to-indigo-500 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 inline-flex items-center justify-center gap-2"
            >
              Daftar Sekarang
              <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Bebas menggunakan framework/library apapun (React, Vue,
                  Laravel, Node.js, dll)
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Aplikasi harus responsive (dapat diakses di desktop dan
                  mobile)
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Karya harus orisinal dan belum pernah dipublikasikan atau
                  dilombakan
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Berupa source code (GitHub), demo live (deployment), dan
                  dokumentasi
                </p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              ...
              <p className="text-slate-600">
                Kelengkapan fitur dan kemampuan aplikasi
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              ...
              <p className="text-slate-600">Clean code dan best practices</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              <div className="text-4xl font-extrabold text-teal-600 mb-3">
                20%
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">
                UI/UX Design
              ...
              <p className="text-slate-600">
                Tampilan menarik dan user-friendly
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              ...
              <p className="text-slate-600">Solusi unik dan fitur inovatif</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Daftarkan tim Anda sekarang dan bangun aplikasi web terbaik untuk
            UMKM Indonesia!
          </p>
