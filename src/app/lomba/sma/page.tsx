...
export default function LombaUIUXPage() {
  return (
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900 text-white pt-32 pb-20 px-4">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <p className="text-xl md:text-2xl mb-4 text-slate-200 font-medium">
            Desain Antarmuka Aplikasi Promosi Wisata Lokal
          </p>
          <p className="text-base md:text-lg mb-10 max-w-3xl text-slate-300 leading-relaxed">
            Rancang desain aplikasi mobile yang menarik untuk mempromosikan
            destinasi wisata lokal Indonesia menggunakan Figma.
          </p>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 hover:shadow-md transition">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Rp 75.000</p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 hover:shadow-md transition">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Rp 5 Juta</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-10 h-10 bg-cyan-100 text-cyan-600 rounded-full flex items-center justify-center font-bold">
                1
              </div>
              <div>
                ...
                <p className="text-slate-600">
                  Peserta adalah siswa aktif SMA/SMK sederajat
                </p>
              </div>
            </div>
            <div className="flex gap-4">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 mb-2">Tools Figma</h3>
                <p className="text-slate-600">
                  Desain harus dibuat menggunakan Figma
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Minimal 8 screens dengan prototype yang lengkap
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Karya harus orisinal dan belum pernah dilombakan
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 mb-2">Submisi</h3>
                <p className="text-slate-600">
                  Link Figma, presentasi deck, dan video demo prototype
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              <div className="text-4xl font-extrabold text-cyan-600 mb-3">
                35%
              </div>
              ...
              <p className="text-slate-600">
                Estetika tampilan dan konsistensi design system
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              ...
              <p className="text-slate-600">
                Kemudahan penggunaan dan alur navigasi
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              ...
              <p className="text-slate-600">
                Inovasi dan keunikan konsep desain
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-md transition">
              ...
              <p className="text-slate-600">Kelengkapan interaksi dan flow</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Daftarkan tim Anda sekarang dan tunjukkan kreativitas desain UI/UX
            terbaik Anda!
          </p>
